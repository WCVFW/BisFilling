                    ...
                    <div className="relative z-20 flex flex-col items-start pt-10 pb-12 lg:flex-row lg:pb-0">
                        ...
                        <div className="relative z-20 w-full p-4 pb-20 text-white lg:w-3/5 md:p-6">
                            ...
                            <p className="flex items-center justify-center gap-2 mb-4 font-semibold text-white lg:justify-start">
                                ...
                                <span>#1 Producer Company Registration Service</span>
                                <Star className="w-4 h-4 text-yellow-400 fill-yellow-400" />
                            </p>
                            ...
                            <p className="text-[#fff] text-lg max-w-lg mb-6">
                                Register your Producer Company (FPO) with expert assistance. Empower farmers, gain market access, and leverage government schemes.
                            </p>

                            <div className="mb-8 space-y-1">
                                <p className="flex items-center gap-2 text-[#fff] text-sm"><span className="block w-2 h-2 bg-green-500"></span> Error-free incorporation with FPO name registration in 3 days.</p>
                                <p className="flex items-center gap-2 text-[#fff] text-sm"><span className="block w-2 h-2 bg-indigo-500"></span> Expert assisted drafting of MOA and bylaws for full compliance.</p>
                            </div>
                        </div>
                        ...
                        <div className="w-full lg:w-[400px] relative z-30 lg:mt-0 lg:ml-auto mt-[-20px] sm:mt-[-20px] mb-12 lg:mr-4">
                            ...
                            >
                                <h2 className="mb-4 text-xl font-semibold text-gray-800 font-sans">Register Your Producer Company</h2>
