                    ...
                    <div className="relative z-20 flex flex-col items-start pt-10 pb-12 lg:flex-row lg:pb-0">
                        ...
                        <div className="relative z-20 w-full p-4 pb-20 text-white lg:w-3/5 md:p-6">
                            ...
                            <p className="flex items-center justify-center gap-2 mb-4 font-semibold text-white lg:justify-start">
                                ...
                                <span>#1 Partnership Firm Registration Service</span>
                                <Star className="w-4 h-4 text-yellow-400 fill-yellow-400" />
                            </p>
                            ...
                            <p className="text-[#fff] text-lg max-w-lg mb-6">
                                Register your Partnership Firm with expert assistance. Enjoy ease of setup, minimal compliance, and shared responsibilities.
                            </p>

                            <div className="mb-8 space-y-1">
                                <p className="flex items-center gap-2 text-[#fff] text-sm"><span className="block w-2 h-2 bg-green-500"></span> 100% online registration process with expert support.</p>
                                <p className="flex items-center gap-2 text-[#fff] text-sm"><span className="block w-2 h-2 bg-indigo-500"></span> Get legal recognition, tax benefits, and business support.</p>
                            </div>
                        </div>
                        ...
                        <div className="w-full lg:w-[400px] relative z-30 lg:mt-0 lg:ml-auto mt-[-20px] sm:mt-[-20px] mb-12 lg:mr-4">
                            ...
                            >
                                <h2 className="mb-4 text-xl font-semibold text-gray-800 font-sans">Register Your Partnership Firm</h2>
                                <form className="space-y-3">
                                    <input className="w-full px-4 py-2 bg-[#F4F4F4] border border-[#E0E0E0] rounded-lg text-sm text-gray-500 placeholder-gray-400 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500" placeholder="Proposed Firm Name" />
            ...
            <section className="py-8 sm:py-16 px-4 md:px-8 bg-gray-50">
                <div className="max-w-7xl mx-auto">
                    ...
                    <p className="text-sm sm:text-lg text-gray-600 mb-8 sm:mb-10 text-center">
                         provides expert assistance for partnership registration, ensuring compliance and business support.
                    </p>
