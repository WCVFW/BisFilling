...
const LMOverviewContent = () => (
  <section id="lm-overview-content" className="py-12 scroll-mt-24">
    <h2 className="mb-6 text-3xl font-bold text-gray-800">Legal Metrology - Overview</h2>
    ...
    <h3 className="mb-6 text-2xl font-bold text-gray-800">Mandatory Information on Pre-packaged Goods (LMPC Rules)</h3>
...
const LMRulesProvisions = () => (
  <section id="lm-rules-provisions" className="py-12 scroll-mt-24">
    <h3 className="mb-8 text-3xl font-bold text-gray-800">Key Rules and Legal Provisions of the Legal Metrology Act</h3>
    <p className="max-w-4xl mb-8 text-lg text-gray-700">
    ...
    <h4 className="mb-6 text-2xl font-bold text-gray-800">Core Legal Metrology Rules, 2011</h4>
    <div className="grid gap-6 mb-12 md:grid-cols-2 lg:grid-cols-3">
      {legalMetrologyRules.map((rule, i) => (
        <div
          key={i}
          className="flex items-start gap-4 p-6 bg-white shadow-md rounded-xl"
        >
          {/* Icon */}
          <BookOpen className="w-6 h-6 mt-1 text-blue-500" />

          {/* Text */}
          <div>
            <h3 className="mb-1 text-lg font-bold">{rule.title}</h3>
    ...
    <h4 className="mb-6 text-2xl font-bold text-gray-800">Prohibitions and Penalties (Sections 19 & 38)</h4>
    <div className="max-w-4xl pl-4 space-y-3 text-gray-700 border-l-4 border-red-500">
      {lmProhibitions.map((prohibition, i) => (
        <li key={i} className="flex items-start gap-2 list-none">
          <AlertTriangle className="flex-shrink-0 w-5 h-5 mt-1 text-red-500" />
...
const LMBenefitsContent = () => (
  <section id="lm-benefits-content" className="py-12 scroll-mt-24">
    <h3 className="mb-8 text-3xl font-bold text-gray-800">Importance and Benefits of LMPC Certificate</h3>
...
const LMEligibilityContent = () => (
  <section id="lm-eligibility-content" className="py-12 scroll-mt-24">
    <h3 className="mb-6 text-3xl font-bold text-gray-800">Eligibility Criteria for Legal Metrology Registration</h3>
    <p className="max-w-4xl mb-8 text-lg text-gray-700">
    ...
    <h4 className="mb-6 text-2xl font-bold text-gray-800">LMPC Registration Requirements Checklist</h4>
    ...
    <h4 className="mb-6 text-2xl font-bold text-gray-800">LMPC Certificate Exemptions (Who Does Not Need Registration)</h4>
    <div className="grid gap-6 md:grid-cols-2">
      {lmpcExemptions.slice(0, 4).map((item, i) => (
        <div key={i} className="flex items-start gap-3 p-4 border border-green-200 rounded-lg shadow-sm bg-green-50">
...
const LMDocumentsContent = () => (
  <section id="lm-documents-content" className="py-12 scroll-mt-24">
    <h3 className="mb-6 text-3xl font-bold text-gray-800">Documents, Validity, and Renewal</h3>
    <p className="max-w-4xl mb-8 text-lg text-gray-700">
    ...
    <h4 className="mb-6 text-2xl font-bold text-gray-800">Key Documents for Application and Renewal</h4>
    ...
    <h4 className="mb-6 text-2xl font-bold text-gray-800">LMPC Certificate Validity and Renewal Process</h4>
    <div className="p-5 border-l-4 shadow-md bg-amber-50 rounded-xl border-amber-500">
      <p className="mb-2 text-lg font-semibold text-gray-700">The validity of an LMPC certificate is **five years**.</p>
...
const LMProcedureContent = () => (
  <section id="lm-procedure-content" className="py-12 scroll-mt-24">
    <h3 className="mb-6 text-3xl font-bold text-gray-800">Legal Metrology Registration - Procedure</h3>
    <p className="max-w-4xl mb-8 text-lg text-gray-700">
    ...
    <h4 className="mb-6 text-2xl font-bold text-gray-800">Step-by-Step Registration and Approval Process</h4>
    ...
    <h4 className="mt-12 mb-6 text-2xl font-bold text-gray-800">Who Needs to Register for LMPC Certificate?</h4>
    <div className="space-y-4">
      <div className="p-4 bg-white border-l-4 border-indigo-500 rounded-lg shadow-md">
        <h5 className="mb-1 text-lg font-semibold text-gray-800">Case 1: Registration for importing, producing, and packaging packaged goods (Rule 27)</h5>
        <p className="text-sm text-gray-700">Every importer, producer, and packer of packaged goods is required to register with the State's Controller or the Director of Legal Metrology of the Central Government.</p>
      </div>
      <div className="p-4 bg-white border-l-4 border-indigo-500 rounded-lg shadow-md">
        <h5 className="mb-1 text-lg font-semibold text-gray-800">Case 2: Registering imported weights and dimensions (Section 19 & 38)</h5>
        <p className="text-sm text-gray-700">No one is permitted to import any weights or measurements unless they have registered with the Director and paid the necessary fees. Penalties apply for non-compliance.</p>
      </div>
    </div>
  </section>
);
...
const LMWhyVakilsearch = () => (
  <section id="lm-why-vakilsearch" className="py-12 scroll-mt-24">
    <h3 className="mb-6 text-3xl font-bold text-gray-800">Why Should You Choose Vakilsearch for Legal Metrology?</h3>
    <p className="max-w-4xl mb-8 text-lg text-gray-700">
    ...
    <div className="mt-12 p-6 bg-[#E6F0F6] rounded-xl border-l-4 border-amber-500 shadow-md">
      <h4 className="flex items-center gap-2 mb-2 text-xl font-bold text-gray-800"><Scale className="w-5 h-5 text-amber-500" /> Why Legal Metrology Registration is Crucial</h4>
      <p className="text-lg font-semibold text-gray-700">Abiding by the Legal Metrology Act protects consumer rights, ensures ethical marketing, and avoids severe fines and potential imprisonment for non-compliance, safeguarding your brand's reputation and growth.</p>
    </div>
  </section>
);

const LMFAQsContent = ({ faqs, faqOpen, setFaqOpen }) => (
  <section id="lm-faqs-content" className="max-w-5xl py-12 mx-auto scroll-mt-24">
    <h3 className="mb-8 text-3xl font-bold text-center text-gray-800">FAQ's on Legal Metrology Online Services</h3>
