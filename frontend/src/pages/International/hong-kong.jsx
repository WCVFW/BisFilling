...
const hkProcessSteps = [
  ...
  "Step 2: Upload documents – Submit passport, address proof, and ownership details securely via .",
  "Step 3: Get name approved –  coordinates with the Companies Registry for fast approval.",
  ...
  "Step 6: Apply for bank account & license (if required) –  assists with post-registration setup for smooth operations.",
];
...
const HKProcessContent = () => (
  <section id="hk-process-content" className="py-12 scroll-mt-24">
    ...
    <p className="text-lg text-gray-700 mb-8 max-w-4xl">
      The Hong Kong incorporation process is quick and can be completed online. Here’s how to register a company in Hong Kong with ’s expert support:
    </p>
...
const HKWhyVakilsearch = () => (
  <section id="hk-why-vakilsearch" className="py-12 scroll-mt-24">
    ...
    <p className="text-lg text-gray-700 mb-8 max-w-4xl">
      Choosing  Hong Kong service ensures a trouble-free incorporation journey, whether you are an Indian entrepreneur or an international business owner. With our dedicated team, we provide simple and available support to the offshore company.
    </p>
