...
const sgFAQs = [
  { q: "What is the process to register a company in Singapore?", a: "The process is completed online via ACRA’s BizFile+ portal, involving name reservation, appointing directors/shareholders, securing a local address, and submitting incorporation documents. Service providers like  can manage this end-to-end." },
  ...
  { q: "Can I register a Singapore company from India?", a: "Yes, registration can be done entirely remotely from India or any other country with the help of a registered corporate service provider like /Vakilsearch." },
  ...
  <section id="sg-overview-content" className="py-12 scroll-mt-24">
    ...
    <div className="p-6 bg-[#E6F0F6] rounded-xl border-l-4 border-[#022B50] shadow-md">
      <p className="text-gray-800 font-semibold">
        **** can assist you throughout the process, from document preparation to compliance, ensuring your Singapore company registration is **fast, accurate, and error-free**.
      </p>
      <p className="text-xs text-gray-500 mt-2">
        (Note:  and Vakilsearch are used interchangeably based on the original content provided.)
      </p>
    </div>
  </section>
);
...
const SGProcessContent = () => (
  <section id="sg-process-content" className="py-12 scroll-mt-24">
    ...
    <p className="mt-8 text-lg text-gray-700 max-w-4xl">
      With **’s expert support**, you can complete every step of the company registration process efficiently. We assist with selecting the appropriate business structure, preparing and reviewing all required documents, submitting your application to ACRA, and appointing a qualified corporate secretary. Our team ensures full compliance with Singapore’s regulatory requirements and handles all administrative tasks on your behalf.
    </p>
  </section>
);
