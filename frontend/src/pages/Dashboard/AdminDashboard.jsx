...
const crmNavItems = [
  ...
  { path: "/dashboard/admin/customers", label: "Customer Lifecycle", icon: "👥" },
  { path: "/dashboard/admin/reports", label: "Reports & Analytics", icon: "📄" },
];

const hrNavItems = [
  { path: "/dashboard/admin/employees", label: "Employee Management", icon: "👥" },
  { path: "/dashboard/admin/attendance", label: "Attendance & Leave", icon: "📅" },
  { path: "/dashboard/admin/performance", label: "Performance KPIs", icon: "⭐" },
];

const salesNavItems = [
  { path: "/dashboard/admin/sales-reports", label: "Sales Reports", icon: "📊" },
  { path: "/dashboard/admin/deals", label: "Deals Pipeline", icon: "💰" },
  { path: "/dashboard/admin/lead-scoring", label: "Lead Scoring", icon: "🔥" },
];

const operationsNavItems = [
  { path: "/dashboard/admin/tickets", label: "Support Tickets", icon: "🎫" },
  { path: "/dashboard/admin/tasks", label: "Task Management", icon: "✅" },
  { path: "/dashboard/admin/documents", label: "Document Management", icon: "📎" },
];
